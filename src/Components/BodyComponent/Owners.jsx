    ...
    return (
        <div>
            <div className="container">
                <div className="display-6 px-3 fw-bold mt-3 ">All Owners</div>
            </div>
            {staff.length === 0 ? (
                ...
                <div class="table-responsive">
                    <table className="table mx-3 mt-3 ">
                        <thead>
                            <tr style={{background:'#466189'}} className="text-white">
                                <th scope="col">Sr.</th>
                            ...
                            return (
                                <tr>
                                    ...
                                    <td style={{ width: "5%" }}><div class="d-grid gap-1  justify-content-start">
                                        ...
                                        /> */}
                                        <Link style={{textDecoration:"none"}} to={`/userDetail/${user._id}`}>
